...
public class Keys {
    ...
    public static final ForeignKey<TestReportRecord, ProjectRecord> FK_TEST_REPORT_PROJECT_1 = Internal.createForeignKey(TestReport.TEST_REPORT, DSL.name("fk_test_report_project_1"), new TableField[] { TestReport.TEST_REPORT.PROJECT_ID }, Keys.PK_PROJECT, new TableField[] { Project.PROJECT.ID }, true);
