...
configs=(
    ...
    project-configs/evaluation/commons-utils-es-weak-1s-pit-all.conf
    project-configs/evaluation/eqbench-es-weak-1s.conf
    project-configs/evaluation/eqbench-es-weak-1s-pit-all.conf
    project-configs/evaluation/commons-utils-es-default-1s.conf
    project-configs/evaluation/commons-utils-es-default-1s-pit-all.conf
    project-configs/evaluation/eqbench-es-default-1s.conf
    project-configs/evaluation/eqbench-es-default-1s-pit-all.conf
    project-configs/evaluation/commons-utils-es-weak-60s.conf
    project-configs/evaluation/commons-utils-es-weak-60s-pit-all.conf
    project-configs/evaluation/eqbench-es-weak-60s.conf
    project-configs/evaluation/eqbench-es-weak-60s-pit-all.conf
    project-configs/evaluation/commons-utils-es-default-60s.conf
    project-configs/evaluation/commons-utils-es-default-60s-pit-all.conf
    project-configs/evaluation/eqbench-es-default-60s.conf
    project-configs/evaluation/eqbench-es-default-60s-pit-all.conf
)
...
# Commented configs remain the same as in original script
