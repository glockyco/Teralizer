...
from .formatting import (
    sort_dataframe_by_project, format_thousands_separator, 
    replace_project_names_with_macros, build_latex_table_content
)
...
def generate_dataset_table(df: pd.DataFrame) -> str:
    ...
    df_for_table = df_for_table.rename(columns={
    ...
    numeric_columns = ['Implementation Files', 'Implementation Classes', 'Implementation SLOC', 
                      'Test Files', 'Test Classes', 'Test SLOC', 'Test Methods']
