...
def save_csv_data(
    ...
    Numeric columns are rounded to 2 decimal places to ensure reproducible
...
def save_figure(
    ...
    **kwargs,
    ...
    # Save the figure
    figure.savefig(
        figure_path, format=format, dpi=dpi, bbox_inches=bbox_inches, **kwargs
    )
