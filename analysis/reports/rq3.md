...
**Test changes per project and variant.**
...
source: [`_effects`](https://github.com/glockyco/Teralizer/blob/b46ff655-dirty/analysis/src/teralizer/eval/reports/rq3_suite_size_runtime.py#L53)

**Line changes per project and variant.**
...
**Runtime changes per project and variant.**
...
source: [`_runtime_overhead`](https://github.com/glockyco/Teralizer/blob/b46ff655-dirty/analysis/src/teralizer/eval/reports/rq3_suite_size_runtime.py#L101)
