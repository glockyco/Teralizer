\begin{table}
  \caption[Mutants and detections by mutator and dataset]{Number of mutants and percentage of detections per mutator in \DatasetsEqBenchEs{} and \DatasetsCommons{} projects.}%
  \label{tab:detections-per-mutator}
  \tabstyle
  \begin{tabular*}{\textwidth}{@{\hspace{\tabcolsep}\extracolsep{\fill}}lrrcrrrr}
  \toprule
   &  &  & \multicolumn{5}{c}{Detected \%} \\
  \cmidrule(lr){4-8}
  Mutator & Total & Total \% & \VariantInitial{} & \multicolumn{2}{c}{\VariantNaiveC{}} & \multicolumn{2}{c}{\VariantImprovedC{}} \\
  \midrule
