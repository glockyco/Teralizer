\begin{table}[H]
  \caption[Included tests and classes with covered and uncovered mutants per project]{Number of total, covered, and uncovered mutants in included classes per project.}%
