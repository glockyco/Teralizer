\begin{table}
  \caption[Implementation and test-suite size per evaluation project]{Number of files, classes, source lines of code (SLOC), and test methods per project.}%
  \label{tab:dataset-statistics}
  \tabstyle
  \begin{tabular*}{\textwidth}{@{\hspace{\tabcolsep}\extracolsep{\fill}}lrrrrrrr}
  \toprule
