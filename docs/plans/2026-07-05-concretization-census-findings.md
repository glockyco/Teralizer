...
**Scope warning:** Every count below is scoped evidence from the fixture, sentinel, and antiaction subsets, not a measurement of the RQ6 corpus and must not be quoted as an RQ6 figure. The widening refusal taxonomy and real-corpus measurements now live in [docs/exclusion-model.md](../exclusion-model.md).
