...
`postgres_reporeapers_rq6_v3` = the canonical full-pipeline RepoReapers corpus
...
code versions in its tail; neither may be cited.
...
| RepoReapers RQ6 | full RepoReapers corpus (1161 projects) | IMPROVED 200 | full pipeline (incl. Stage-5 reduction) | RQ6 refresh (real-world unsuccessful-generalization causes on the current pipeline) | `postgres_reporeapers_rq6_v3` (canonical full-pipeline corpus) |
