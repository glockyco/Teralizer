...
- [x] 1.1a Confirm `consolidate-repository-knowledge` is validated, synced, and archived. Consume its
      accepted exclusion-accounting and repository-authority specs at
      `4042046a87e67048cdde506642320435a5865759`.
- [x] 1.1b Confirm the other prerequisites are validated, synced, and archived. Consume
      `consolidate-evaluation-databases` at `edf5ae290a0659266fec28530c4873ab0db0a808`,
...
- [x] 7.3 Review every retained generated RQ6 table, macro, CSV, and Markdown artifact. Confirm semantic
      ...
      recomputation.
- [x] 7.4 Exercise declaration-driven publication into a clean scratch thesis checkout using the
...
- [x] 7.5 Build the scratch thesis with strict LaTeX reference errors and inspect affected pages. This is
...
- [x] 8.1 Record the finalized producer commit, artifact manifest, semantic corpus id, derived-view
...
- [x] 8.2 Confirm the active `reconcile-reporeapers-claims` change records this exact evidence revision
...
- [x] 8.3 Archive only after the scratch publication and compatibility proof pass, the one-time claim
