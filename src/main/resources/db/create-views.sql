...
BEGIN
    ...
    stage_order := CASE
        ...
        WHEN stage = 'ANALYZE_TESTS' THEN 12
        WHEN stage = 'FILTER_TESTS' THEN 13
        WHEN stage = 'FILTER_ASSERTIONS' THEN 14

        WHEN stage = 'ADD_JPF_INSTRUMENTATION' THEN 15
        WHEN stage = 'BUILD_PROJECT_INSTRUMENTED' THEN 16
        WHEN stage = 'EXECUTE_JPF' THEN 17
        WHEN stage = 'ANALYZE_JPF' THEN 18
        WHEN stage = 'CLEANUP_JPF_INSTRUMENTATION' THEN 19

        WHEN stage = 'BUILD_PROJECT_INITIAL' THEN 20
        WHEN stage = 'EXECUTE_TESTS_INITIAL' THEN 21

        WHEN stage = 'COLLECT_JUNIT_REPORTS_INITIAL' THEN 22

        WHEN stage = 'CLEANUP_GENERALIZATION' THEN 23

        WHEN stage = 'GENERALIZE_TESTS' THEN 24
        WHEN stage = 'BUILD_PROJECT_GENERALIZED' THEN 25

        WHEN stage = 'EXECUTE_TESTS_GENERALIZED' THEN 26
        WHEN stage = 'COLLECT_JUNIT_REPORTS_GENERALIZED' THEN 27
        WHEN stage = 'FILTER_GENERALIZATIONS' THEN 28

        WHEN stage = 'COLLECT_PIT_DATA_ORIGINAL' THEN 29
        WHEN stage = 'COLLECT_JACOCO_DATA_INITIAL' THEN 30
        WHEN stage = 'COLLECT_PIT_DATA_INITIAL' THEN 31
        WHEN stage = 'RESTORE_GENERALIZED_BUILD' THEN 32
        WHEN stage = 'COLLECT_JACOCO_DATA_GENERALIZED' THEN 33
        WHEN stage = 'COLLECT_PIT_DATA_GENERALIZED' THEN 34
    END;
