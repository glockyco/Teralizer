...
CREATE OR REPLACE VIEW mutation_results_by_variant AS
WITH base_data AS (
    SELECT
...
CREATE OR REPLACE VIEW mutation_results_by_variant_mutator AS
WITH base_data AS (
    SELECT
        variant_name(pmr.stage, pmr.variant) AS variant,
...
CREATE OR REPLACE VIEW mutation_results_by_project_variant AS
WITH base_data AS (
    SELECT
        pmr.project_id,
...
CREATE OR REPLACE VIEW mutation_results_by_project_variant_mutator AS
WITH base_data AS (
    SELECT
        pmr.project_id,
        project_name(pmr.project_id) AS project_name,
