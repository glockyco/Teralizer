...
public class BaselineTestParametersSupplierFactory {
    ...
    public static CtClass<?> createSupplierClass(Factory factory, List<MethodParameter> parameters, List<MethodArgument> arguments) {
    ...
    private static List<String> createSupplierBodies(List<MethodParameter> parameters, List<MethodArgument> arguments) {
        ...
        if (parameters.isEmpty()) {
            ...
            for (int i = 0; i < parameters.size(); i++) {
                ...
                String body = createArbitrary(parameters.get(i), arguments.get(i));
